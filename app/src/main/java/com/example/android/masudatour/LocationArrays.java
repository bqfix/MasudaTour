...
public class LocationArrays {
    ...
    public static ArrayList<Location> getRestaurants(Context context) {
        return new ArrayList<Location>(Arrays.asList(
                ...
                new Location(context.getString(R.string.saku), context.getString(R.string.saku_descrip), new int[] {R.drawable.dogs}, context.getString(R.string.saku_address), context.getString(R.string.saku_hours), context.getString(R.string.saku_url)),
                new Location(context.getString(R.string.saku_yakiniku), context.getString(R.string.saku_yakiniku_descrip), new int[] {R.drawable.dogs}, context.getString(R.string.saku_yakiniku_address), context.getString(R.string.saku_yakiniku_hours), context.getString(R.string.saku_yakiniku_url)),
                new Location(context.getString(R.string.yasumasa), context.getString(R.string.yasumasa_descrip), new int[] {R.drawable.dogs}, context.getString(R.string.yasumasa_address), context.getString(R.string.yasumasa_hours), context.getString(R.string.yasumasa_url)),
                new Location(context.getString(R.string.tenshin), context.getString(R.string.tenshin_descrip), new int[] {R.drawable.dogs}, context.getString(R.string.tenshin_address), context.getString(R.string.tenshin_hours), context.getString(R.string.tenshin_url)),
                new Location(context.getString(R.string.kikkouya_udon), context.getString(R.string.kikkouya_udon_descrip), new int[] {R.drawable.dogs}, context.getString(R.string.kikkouya_udon_address), context.getString(R.string.kikkouya_udon_hours), context.getString(R.string.kikkouya_udon_url)),
                new Location(context.getString(R.string.meiju), context.getString(R.string.meiju_descrip), new int[] {R.drawable.dogs}, context.getString(R.string.meiju_address), context.getString(R.string.meiju_hours), context.getString(R.string.meiju_url))
        ));
    }
